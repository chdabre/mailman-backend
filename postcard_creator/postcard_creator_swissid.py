...
class PostcardCreatorSwissId(PostcardCreatorBase):
    ...
    def send_free_card(self, postcard, mock_send=False, image_export=False, **kwargs):
        ...
        img_base64 = base64.b64encode(rotate_and_scale_image(postcard.picture_stream,
                                                             ...
                                                             enforce_size=True,
                                                             **kwargs)).decode('ascii')
        if postcard.text_image_stream:
            logger.info('Using provided text image')
            img_text_base64 = base64.b64encode(rotate_and_scale_image(postcard.text_image_stream,
                                                                      img_format='jpeg',
                                                                      image_quality_factor=1,
                                                                      image_target_width=720,
                                                                      image_target_height=744,
                                                                      image_export=image_export,
                                                                      export_name='text',
                                                                      enforce_size=True,
                                                                      image_rotate=False,
            ...
            logger.info('Generating text image')
